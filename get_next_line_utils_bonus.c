...
/*   Updated: 2022/07/24 15:58:45 by nfukuma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_delete_one_strage(t_list **static_p, t_list **lst_p)
{
...
char	*ft_push_end_line(t_list **lst_p)
{
	char	*newline;
	size_t	i;
...
char	*ft_parse_readsize(ssize_t readsize, char **buf, t_list **lst_p,
		t_list **static_p)
{
	free(*buf);
	*buf = NULL;
...
char	*ft_read_file_push_line(t_list **lst_p, t_list **static_p)
{
	char	*buf;
	char	*catstr;
	ssize_t	readsize;
