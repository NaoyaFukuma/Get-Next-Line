...
/*   Updated: 2022/07/24 15:31:58 by nfukuma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line_bonus.h"

char	*ft_split_and_store_text(char *str, size_t strlen, t_list *lst_p)
{
	char	*newline;
	char	*tmp_str;
	size_t	i;
...
t_list	*ft_set_pointer(t_list **static_p, t_list **lst_p, int fd)
{
	if (*static_p == NULL)
